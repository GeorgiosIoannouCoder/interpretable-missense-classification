...
\centering
\footnotesize
\caption{\textbf{Test-set metrics with 95\% bootstrap CIs.} Main test $n=38{,}526$; AlphaMissense $n=37{,}736$; CADD $n=38{,}792$ (Phase~10 matching).}
\label{tab:results}
...
CADD (ref.)          & 38{,}792 & 0.928 [0.925, 0.931] & 0.839 [0.832, 0.846] & 0.807 [0.803, 0.812] & 0.860 \\
\bottomrule
\end{tabular}
\end{table}
